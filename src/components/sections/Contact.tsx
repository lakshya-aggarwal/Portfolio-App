...
export function Contact() {
  return (
    ...
    >
      ...
      <SplitText as="h2" className="block max-w-[24ch] pt-8 text-h2">
      ...
      <div className="mt-10">
        <Magnetic strength={10}>
          <a
            ...
            data-cursor="write"
            className="group inline-flex items-baseline gap-3 border-b border-line pb-2 text-h3 transition-colors duration-200 hover:border-ink"
          >
            {site.email}
            <ArrowUpRight
