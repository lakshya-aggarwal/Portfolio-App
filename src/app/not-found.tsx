...
export default function NotFound() {
  return (
    <section className="shell flex min-h-[70vh] flex-col justify-center py-32">
      ...
      <Link
        href="/"
        className="mt-10 inline-flex w-max items-center border border-ink px-5 py-3 font-mono text-meta uppercase tracking-label transition-colors duration-200 hover:bg-ink hover:text-ground"
      >
        Back to the start
      </Link>
    </section>
